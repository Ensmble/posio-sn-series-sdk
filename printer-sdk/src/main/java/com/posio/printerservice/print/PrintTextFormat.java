...
public class PrintTextFormat implements Parcelable {
    ...
    private int textSize = 24;// text size, px
    private boolean underline = false;// underline
    private float textScaleX = 1.0f;// horizontal text scale. 0-1 shrinks the text, 1 is normal, >1 enlarges
    private float textScaleY = 1.0f;
    private float letterSpacing = 0;// letter spacing
    private float lineSpacing = 0;// line spacing
    private int topPadding = 0;
    private int leftPadding = 0;
    private int ali = 0;// alignment, default 0. 0--LEFT, 1--CENTER, 2--RIGHT
    private int style = 0; // font style, default 0. 0--NORMAL, 1--BOLD, 2--ITALIC, 3--BOLD_ITALIC
    private int font = 0; // font, default 0. 0--DEFAULT, 1--DEFAULT_BOLD, 2--SANS_SERIF, 3--SERIF, 4--MONOSPACE, 5--CUSTOM
    private String path; // path to a custom font file
